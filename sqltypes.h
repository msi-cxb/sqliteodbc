...
////////////////////////////////////
// cxb fix for x64 data types
#ifdef _WIN64
#define __CXB_64
typedef INT64           SQLLEN;
typedef UINT64          SQLULEN;
typedef UINT64          SQLSETPOSIROW;
typedef INT64           SQLINTEGER;
typedef UINT64          SQLUINTEGER;
...
// cxb fraction needs to be 32 bit regardless of x86/x64
